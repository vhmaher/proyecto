...
const Formato3 = () => {
    ...
    const [p8, setp8] = useState("Consume en el mismo horario");
    const [p9, setp9] = useState("SI");
    const [p10, setp10] = useState("SI");
    const [p11, setp11] = useState("SI");
    const [p12, setp12] = useState("SI");
    const [p13, setp13] = useState("Le lee cuentos");
    const [p14, setp14] = useState("SI");
    const [p15, setp15] = useState("BUENO");
    const [p16, setp16] = useState("SI");
    const [p17, setp17] = useState("SI");
    return (
        <ScrollView>
            <View style={styles.formulario}>
                <Text style={styles.label} >ENCUESTA PARA NIÑOS DE 1 A 3 AÑOS</Text>
                ...
                <Text style={styles.label} >Ud. Realiza la higiene bucal a su niño(a)</Text>
                <Picker
                    selectedValue={p2}
                    style={styles.input}
                    mode={"dialog"}
                ...
                <Text style={styles.label} >El niño(a)¿Qué comio? </Text>
                <Picker
                    selectedValue={p3}
                    style={styles.input}
                    mode={"dialog"}
                ...
                >
                    ...
                    <Picker.Item label="Segundo ó comida espesa" value="b" />
                </Picker>
                ...
                <Text style={styles.label} >¿Le dio habas, frejoles, lentejas u otra menestra a su niño?</Text>
                <Picker
                    selectedValue={p6}
                    style={styles.input}
                    mode={"dialog"}
                ...
                <Text style={styles.label} >¿Que cantidad le esta dando por dia?</Text>
                <TextInput
                    style={styles.input}
                ...
                <Picker
                    ...
                    style={styles.input}
                    mode={"dialog"}
                    onValueChange={(itemValue) => setp17(itemValue)}
                >
                    <Picker.Item label="SI" value="si" />
                    <Picker.Item label="NO" value="no" />
                </Picker>
